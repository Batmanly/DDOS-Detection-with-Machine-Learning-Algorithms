...
class SimpleMonitor13(switch.SimpleSwitch13):
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        (flow.match['eth_type'], flow.match['ipv4_src'], flow.match['ipv4_dst'], flow.match['ip_proto'])):
            ...
            # The flow_id is a unique identifier for each flow. It is created by concatenating the source IP address,
            ...
            # The flow statistics data is saved to a CSV file named PredictFlowStatsfile.csv.
            file0.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n"
    ...
    def flow_training(self):
        ...
        if 'train' == get_command_variables():
            ...
            if os.path.exists('../ml/TrainedModels/rf_model.pkl'):
                self.logger.info("Flow Model exist")
                self.flow_model = joblib.load('../ml/TrainedModels/rf_model.pkl')
            else:
                self.logger.info("Flow Model not exist")
                self.logger.info("Flow Model training")
                self.flow_model = classifier.fit(X_flow_train, y_flow_train)
                joblib.dump(self.flow_model, '../ml/TrainedModels/rf_model.pkl')
