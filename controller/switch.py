...
# Create a class for the controller, which inherits from the RyuApp class,
# Create simple layer 2 switch
class SimpleSwitch13(app_manager.RyuApp):
    ...
    # retrive information from switch
    @set_ev_cls(ofp_event.EventOFPSwitchFeatures, CONFIG_DISPATCHER)
    def switch_features_handler(self, ev):
        datapath = ev.msg.datapath  # retrieves information about the switch from the event message
        ofproto = datapath.ofproto  # retrieves the OpenFlow protocol version from the switch
